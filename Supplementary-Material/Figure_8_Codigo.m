...
% lamInt =conductividad_efectiva_orden_m(cm,cf,Vf,V,S1,H1,H2,40);
%  CENo(jj,:,tt) =conductividad_efectiva_orden_m(lamInt(1),cf,Vc,V,S1,H1,H2,40);
end                                 
end
...
h3 = plot(phi, BU, 'r-.', 'LineWidth', 2.5, 'MarkerEdgeColor', 'r', ...
          'MarkerFaceColor', 'w', 'MarkerSize', 6);
% Plot HL
h4 = plot(phi, BL, 'r--', 'LineWidth', 2, 'MarkerEdgeColor', 'r', ...
          'MarkerFaceColor', 'w', 'MarkerSize', 6);
h = [h, h4];

h5 = plot(phi, HL, 'k-.', 'LineWidth', 2.5, 'MarkerEdgeColor', 'r', ...
          'MarkerFaceColor', 'w', 'MarkerSize', 6);
h = [h, h5];
...
legend_labels{end+1} = '$\sigma_{100}$ sqr';
